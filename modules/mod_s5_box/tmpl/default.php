...
$is_ieany = "yes";
					...
					$mainframe->addCustomHeadTag('<style type="text/css">.s5boxhidden{display:none;} </style>');
					$mainframe->addCustomHeadTag('<script language="javascript" type="text/javascript" >var s5_boxeffect = "'.$s5_boxeffect.'";</script>');
					
					
					if ($s5_jsversion == "mootools" ) {		
						
						if ($s5_moover == "moo13" ) {
						$mainframe->addCustomHeadTag('<script src="'.$url.'js/s5box.js" type="text/javascript"></script>');}
						
						if ($s5_moover == "moo124" ) {
						$mainframe->addCustomHeadTag('<script src="'.$url.'js/moo124/s5box.js" type="text/javascript"></script>');}
					}	
					
					if ($s5_jsversion == "jquery" ) {	
					
						$mainframe->addCustomHeadTag('<script src="'.$url.'js/jquery.min.js" type="text/javascript"></script>');
						$mainframe->addCustomHeadTag('<script src="'.$url.'js/jquery.no.conflict.js" type="text/javascript"></script>');
						$mainframe->addCustomHeadTag('<script src="'.$url.'js/jquery.colorbox.js" type="text/javascript"></script>');  }

							
					
					$mainframe->addCustomHeadTag('<link rel="stylesheet" href="'.$url.'css/s5box.css" type="text/css" />');
					if ($is_ieany == "yes" ) {
					$mainframe->addCustomHeadTag('<link rel="stylesheet" href="'.$url.'css/s5box-ie.css" type="text/css" />');
					}
					
					if ($s5_jsversion == "jquery" ) {	
						$mainframe->addCustomHeadTag('<script type="text/javascript">jQuery(document).ready(function(){ jQuery(".s5box_register").colorbox({width:"38%", inline:true, href:"#s5box_register"});jQuery(".s5box_login").colorbox({width:"25%", inline:true, href:"#s5box_login"});jQuery(".s5box_one").colorbox({width:"'.$s5boxwidth1.'%", inline:true, href:"#s5box_one"});jQuery(".s5box_two").colorbox({width:"'.$s5boxwidth2.'%", inline:true, href:"#s5box_two"});jQuery(".s5box_three").colorbox({width:"'.$s5boxwidth3.'%", inline:true, href:"#s5box_three"});jQuery(".s5box_four").colorbox({width:"'.$s5boxwidth4.'%", inline:true, href:"#s5box_four"});jQuery(".s5box_five").colorbox({width:"'.$s5boxwidth5.'%", inline:true, href:"#s5box_five"});jQuery(".s5box_six").colorbox({width:"'.$s5boxwidth6.'%", inline:true, href:"#s5box_six"});jQuery(".s5box_seven").colorbox({width:"'.$s5boxwidth7.'%", inline:true, href:"#s5box_seven"});jQuery(".s5box_eight").colorbox({width:"'.$s5boxwidth8.'%", inline:true, href:"#s5box_eight"});jQuery(".s5box_nine").colorbox({width:"'.$s5boxwidth9.'%", inline:true, href:"#s5box_nine"});jQuery(".s5box_ten").colorbox({width:"'.$s5boxwidth10.'%", inline:true, href:"#s5box_ten"});});</script>');
					}	
					
					if ($s5_jsversion == "mootools" ) {	
						$mainframe->addCustomHeadTag('<script type="text/javascript">$(window).addEvent("domready", function(){							
