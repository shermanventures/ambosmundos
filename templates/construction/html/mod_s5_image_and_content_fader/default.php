...
$s5ic_url = JURI::root().'templates/construction/html/mod_s5_image_and_content_fader/';

$mainframe->addCustomHeadTag('<script language="javascript" type="text/javascript">var s5_hidecar = "'.$s5_hidecar.'";</script>');
$mainframe->addCustomHeadTag('<script language="javascript" type="text/javascript">var s5_hidebut = "'.$s5_hidebut.'";</script>');
$mainframe->addCustomHeadTag('<script language="javascript" type="text/javascript">var s5_hidetext = "'.$s5_hidetext.'";</script>');

?>
	
<?php if ($jslibrary == "mootools112" || $jslibrary == "mootools124") {  ?>		 
	
<?php if ($jslibrary == "mootools112") { 
	$mainframe->addCustomHeadTag('<script language="javascript" type="text/javascript">var s5_dropdowntext = "'.$s5_dropdowntext.'";</script>');
	
	
	if ($iss_ie8_s5_iacf == "yes" || $iss_ie7_s5_iacf == "yes") { 
		$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/mootools.namespaced.js" type="text/javascript"></script>');
	$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/jd.gallery.namespaced.js" type="text/javascript"></script>');
		
		} else {

	$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/jd.gallery.js" type="text/javascript"></script>');
			
		}		
	$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/jd.gallery.transitions.js" type="text/javascript"></script>');
...
<?php if ($jslibrary == "mootools124") { 
	...
	$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/mootools124/jd.gallery.js" type="text/javascript"></script>');
	$mainframe->addCustomHeadTag('<script src="'.$s5ic_url.'js/mootools124/jd.gallery.transitions.js" type="text/javascript"></script>');
		}
?>	
