...
<div class="contentpaneopen_heading">
	...
	<div class="contentheading<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>">
...
<div class="contentpaneopen<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>">
	...
	<div>
			<div style="clear:both"></div><a href="<?php echo $this->item->readmore_link; ?>" class="readon<?php echo $this->escape($this->item->params->get('pageclass_sfx')); ?>">
				...
				endif; ?></a><div style="clear:both"></div>
	</div>
	<?php endif; ?>
