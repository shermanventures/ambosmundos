...
if (($numIntroArticles != $startIntroArticles) && ($i < $this->total)) : ?>
		...
		<?php
			...
			for ($z = 0; $z < $this->params->def('num_columns', 2); $z ++) :
				...
				?>
				<div style="width:<?php echo intval(100 / $this->params->get('num_columns')) ?>%;float:left;" class="article_column<?php echo $divider ?>">
				<?php
				...
				for ($z = 0; $z < $this->params->get('num_columns'); $z ++) :
					if ($z > 0) : $divider = " column_separator"; endif; ?>
					<div style="width:<?php echo intval(100 / $this->params->get('num_columns')) ?>%;" class="article_column<?php echo $divider ?>">
...
<?php if ($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2 && $this->pagination->get('pages.total') > 1)) : ?>
	...
	<div class="s5_pages" style="text-align:center;">
...
<?php if ($this->params->def('show_pagination_results', 1)) : ?>
	...
	<div class="s5_pages_counter" style="text-align:center;">
