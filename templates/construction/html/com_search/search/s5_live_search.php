...
<div id="s5_search_results">			
	<?php
		...
		?>
			<div class="s5_ls_top_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px">
				...
				<div style="height:26px; width:26px" onclick="javascript:closeResultDiv();" id="s5_ls_close"></div>
			</div>
		...
		<?php	
			...
			<?php if ($tab == "s5_ls_result1") { ?>
				<div onmouseout="this.style.backgroundColor='#<?php echo $_SESSION['result1_bg_color'] ?>'" onmouseover="this.style.backgroundColor='#<?php echo $_SESSION['result1_bg_hover_color'] ?>'" class="s5_ls_result1" style="padding-bottom:<?php echo $_SESSION['result_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['result_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['result_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['result_padding_lr'] ?>px; background:#<?php echo $_SESSION['result1_bg_color'] ?>">
					...
					<span style="font-size:<?php echo $_SESSION['result_font_size'] ?>px; color:#<?php echo $_SESSION['result1_font_color'] ?>" class="s5_ls_result1_text" >
						<?php echo $result->text ; ?>&nbsp;<br/><br/><a onmouseout="this.style.textDecoration='none'" onmouseover="this.style.textDecoration='underline'" class="s5_ls_readmore" style="font-size:<?php echo $_SESSION['result_font_size'] ?>px; color:#<?php echo $_SESSION['result1_readmore_font_color'] ?>" href="<?php echo $result->href?>"><?php echo $_SESSION['readmore_text'] ?></a>
					</span>		
				</div>	
			<?php } ?>
			...
			<?php if ($tab == "s5_ls_result2") { ?>
				<div onmouseout="this.style.backgroundColor='#<?php echo $_SESSION['result2_bg_color'] ?>'" onmouseover="this.style.backgroundColor='#<?php echo $_SESSION['result2_bg_hover_color'] ?>'" class="s5_ls_result2" style=" padding-bottom:<?php echo $_SESSION['result_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['result_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['result_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['result_padding_lr'] ?>px; background:#<?php echo $_SESSION['result2_bg_color'] ?>">
					<h2 style="margin-bottom:<?php echo $_SESSION['result_padding_tb'] ?>px">
					...
					<span style="font-size:<?php echo $_SESSION['result_font_size'] ?>px; color:#<?php echo $_SESSION['result2_font_color'] ?>" class="s5_ls_result2_text" >
						<?php echo $result->text ; ?>&nbsp;<br/><br/><a onmouseout="this.style.textDecoration='none'" onmouseover="this.style.textDecoration='underline'" class="s5_ls_readmore" style="font-size:<?php echo $_SESSION['result_font_size'] ?>px; color:#<?php echo $_SESSION['result2_readmore_font_color'] ?>" href="<?php echo $result->href?>"><?php echo $_SESSION['readmore_text'] ?></a>
					</span>		
				</div>	
			<?php } ?>
		...
		?>
			<div class="s5_ls_bottom_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px">
				<a class="s5_ls_bar_a" href="<?php echo JRoute::_('index.php?option=com_search&view=search&searchphrase='.$searchphrase.'&ordering='.$ordering.'&limit=0&searchword='.$searchword); ?>">
					<span onmouseout="this.style.textDecoration='none'" onmouseover="this.style.textDecoration='underline'" class="s5_ls_bar_span" style="color:#<?php echo $_SESSION['bar_font_color'] ?>; font-size:<?php echo $_SESSION['bar_font_size'] ?>px">
						<?php echo $this->pagination->total.' '.$resultsText; ?>
					</span>
		...
		?>
			<div class="s5_ls_top_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; height:14px; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px; background-color:#<?php echo $_SESSION['bar_bg_color'] ?>">				
				<div style="height:26px; width:26px" onclick="javascript:closeResultDiv();" id="s5_ls_close"></div>
			</div>
			...
			<div class="s5_ls_bottom_bar" style="background:#<?php echo $_SESSION['bar_bg_color'] ?>; height:14px; padding-bottom:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-top:<?php echo $_SESSION['bar_padding_tb'] ?>px; padding-right:<?php echo $_SESSION['bar_padding_lr'] ?>px; padding-left:<?php echo $_SESSION['bar_padding_lr'] ?>px; background:#<?php echo $_SESSION['bar_bg_color'] ?>">				
			</div>
		<?php	
		}
	?>												
